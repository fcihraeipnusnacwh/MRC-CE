...
flags.DEFINE_string("xlnet_config", default="xlnet_cased_L-12_H-768_A-12/xlnet_config.json", help="xlnet config file dir")
flags.DEFINE_string("init_checkpoint", default="xlnet_cased_L-12_H-768_A-12/xlnet_model.ckpt", help="xlnet model init checkpoint")
flags.DEFINE_string("spm", default="xlnet_cased_L-12_H-768_A-12/spiece.model", help="spiece model file")
